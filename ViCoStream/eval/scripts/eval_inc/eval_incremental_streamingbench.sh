...
RUN_NAME="timechat-none-baseline-s0_25-eager-chunk-intra-cs4-acn4-ur32-qwen7B-streaming"
...
RESULT_DIR="outputs/eval/streamingbench/${RUN_NAME}"


${PYTHON_BIN} eval/scripts/incremental_streamingbench.py \
   --run_name ${RUN_NAME} \
