...
class BaseArguments(CompatArguments, GenerationArguments, QuantizeArguments, DataArguments, TemplateArguments,
    ...
    # ViCoStream replace code
    vision_pool_type: str = 'none'  # none, entropy, avg, max
    sim_threshold: float = 0.7
    spatial_keep_ratio: float = 1.
    chunk_size: int = 4
    drop_method: str='feature'  # feature, chunk, nearest, uniform

    attend_chunk_num: int = 1
    user_query_retrieval: int = -1

    sliding_window: int = 1000000

    nearest_window_size: int = 300
